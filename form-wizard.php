                                        ...
                                        <div class="row">
                                            <div class="col m6">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <label >Header</label>
                                                        <input  name="header" type="text" class="required validate">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label >Line 1</label>
                                                        <input  name="line1" type="text" class="required validate">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label >Line 2</label>
                                                        <input  name="line2" type="text" class="required validate">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label >Line 3</label>
                                                        <input  name="line3" type="text" class="required validate">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label >Line 4</label>
                                                        <input  name="line4" type="text" class="required validate">
                                                    </div>
                                            ...
                                            <div class="col m6">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <label >Line 5</label>
                                                        <input  name="line5" type="text" class="required validate">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label >PO</label>
                                                        <input  name="po" type="text" class="required validate">
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <label >Item</label>
                                                        <input  name="item" type="text" class="required validate">
                                                    </div>

                                                    <div class="input-field col s12">
                                                        <label >PCs</label>
                                                        <input  name="pcs" type="text" class="required validate">
                                                    </div>
...
<!--                                                    </div>-->
                                                    ...
                                                    <div class="input-field col s12">
                                                        <input class="waves-effect waves-light btn red"  type="submit" value="Submit"></input>
                                                    </div>
                                                </div>
                                            </div>
